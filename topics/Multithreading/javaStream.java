...
public class javaStream {
        ...
        void main() {
                ...
                Map<Boolean, List<Integer>> coll = numbers.stream().collect(Collectors.partitioningBy(n -> n % 2 == 0));
                ...
                highestDept.ifPresent(e -> System.out.println(e.getKey() + " = " + e.getValue()));
                ...
                mNumbers.stream().max(Comparator.comparingInt(Integer::intValue)).ifPresent(System.out::println);
